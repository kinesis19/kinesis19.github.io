...
![img1](/assets/img/2024_10_03/Windows11_Install_with_usb/img1.png)
...
![img2](/assets/img/2024_10_03/Windows11_Install_with_usb/img2.png)
...
![img3](/assets/img/2024_10_03/Windows11_Install_with_usb/img3.png)
<center>[Windows 언어 및 버전 선택]</center>
<br>

다음 버튼을 클릭해 준다. `사용할 미디어 선택` 항목에서 무조건 `USB 플래시 드라이브`를 선택해 준다.
![img4](/assets/img/2024_10_03/Windows11_Install_with_usb/img4.png)
...
![img5](/assets/img/2024_10_03/Windows11_Install_with_usb/img5.png)
<center>[Windows 사용할 미디어 선택]</center>
<br>

설치가 완료되면 `마침` 버튼을 눌러 준다.
![img6](/assets/img/2024_10_03/Windows11_Install_with_usb/img6.png)
...
![img7](/assets/img/2024_10_03/Windows11_Install_with_usb/img7.png)
<center>[BIOS 창에서 Windows11 Booting USB로 선택하기]</center>
<br>


![img8](/assets/img/2024_10_03/Windows11_Install_with_usb/img8.png)
...
![img9](/assets/img/2024_10_03/Windows11_Install_with_usb/img9.png)
...
![img10](/assets/img/2024_10_03/Windows11_Install_with_usb/img10.png)
<center>[Windows11 추가 드라이버 설치 화면]</center>
<br>

이후 설정을 몇 번 더 해주면 Windows11이 설치된다.

![img11](/assets/img/2024_10_03/Windows11_Install_with_usb/img11.png)
