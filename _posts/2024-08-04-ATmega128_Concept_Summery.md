...
![ATmega128_TCCRnA](/assets/img/2024_08_04/ATmega128_TCCRnA.png)

> [Bit7:6]
> COMnA1:0 : Compare Output Mode for Channel A
...
> TCCR1B에 WGM13, WGM12과 결합하여 Working Mode를 Setting합니다.
...
![ATmega128_TCCRnB](/assets/img/2024_08_04/ATmega128_TCCRnB.png)

> [Bit7] ICNC1(Input Capture Noise Canceler)<br>
> Bit7을 1로 Setting해주면 Input Capture 단자 ICP1로 Input되는 Capture Sinal을 위한 Noise Delete Circuit이 작동됩니다. Noise Delete Circuit이 작동하면 Input Capture Signal을 Filtering하게 되는데 이를 이용하면
System Clock의 4 Cycle만큼 Delay되어 작동합니다.

> [Bit6]ICES1(Input Capture Edge Select)<br>
> Input Capture 단자 ICP1로 Inpupt되는 Signal의 Edge의 Detecting Method를 결정합니다.
> - 1 : Rising Edge일 때 검출합니다.
> - 0 : Falling Edge일 때 검출합니다.

> [Bit5] WGM13, WGM12 : Waveform Generation Mode<br>
>  TCCR1A에 WGM11, WGM10과 결합하여 Working Mode를 Setting합니다.

> [Bit4:3] : WGM13, WGM12 : Waveform Generation Mode<br>
> TCCR1A에 WGM11, WGM10과 결합하여 Working Mode를 Setting합니다.

> [Bit2:0]
> ![Atmega128_TCCRnB_Mode](/assets/img/2024_08_04/Atmega128_TCCRnB_Mode.png)

![ATmega128_Waveform_Generation_Mode_Bit_Description2](/assets/img/2024_08_04/ATmega128_Waveform_Generation_Mode_Bit_Description2.png)
...
![Atmega128_TCCRnC](/assets/img/2024_08_04/ATmega128_TCCRnC.png)

> [Bit7:5] FOC1x(Force Output Compare for Channel x)
> Force Output Compare Bit는 CTC Mode 또는 PWM Mode에서 강제로 Output Compare를 발생시킬 때 사용된다. 일반적으로 Output Compare Match가 발생하면 Setting된 Action (핀 토글, 설정, 클리어 등)이 수행되지만, FOC Bit를 사용하면 현재 Timer value를 무시하고 즉시 Output Compare 동작을 강제로 수행할 수 있습니다.

### TCNT1H and TCNT1L
Timer/Counter1의 16bit counter value를 저장하고 있습니다.
![ATmega128_TCNT1H_TCNT1L](/assets/img/2024_08_04/ATmega128_TCNT1H_TCNT1L.png)

### OCR1x
TCNT1과 compare하여 OC1x 단자에 출력 신호를 발생하기 위한 16Bit register입니다.
![ATmega128_OCR1AH_OCR1AL](/assets/img/2024_08_04/ATmega128_OCR1AH_OCR1AL.png)

### ICR1
Input Capture Signal ICP1에 의하여 TCNT1 value를 capture하여 save하는 16Bit register입니다.
Fast PWM Mode에서 Timer의 TOP value로 Setting될 수 있습니다.
![ATmega128_ICR1H_ICR1L](/assets/img/2024_08_04/ATmega128_ICR1H_ICR1L.png)


### TIFR
TIFR(Timer/Counter Interrupt Flag Register)은 
![ATmega128_TIFR](/assets/img/2024_08_04/ATmega128_TIFR.png)

> [Bit5] ICF1(Timer/Counter1 Input Capture Flag)<br>
Timer/Counter1의 외부 IC1핀의 Input Capture Signal 또는 Analog 비교기의 Signal로 인하여  Capture 동작이 되면 Bit5가 1로 Setting되면서 Input Capture Interrupt가 request됩니다.
Bit5는 Interrupt 처리의 시작과 함께 0으로 Clear됩니다.
