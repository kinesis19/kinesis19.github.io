...
![img1](/assets/img/2024_10_10/OODP_DesignPattern_Facade/img2.png)
<center> [실행 결과] </center> <br>

선언부(.h)와 구현부(.cpp)는 나누지 않고, main.cpp에서 통합하여 코드를 구현했다. 
...
- [Design Patterns in C++](https://refactoring.guru/design-patterns/cpp) by **Refactoring.Guru** - 리팩토링, 디자인 패턴, SOLID 원칙에 대해 
