...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/kinesis19", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "Kinesis",
	bio: "Robotics & Metaverse Developer",
	links: [
		// {
		// 	name: "Twitter",
		...
		// },
		{
			...
			url: "https://github.com/kinesis19",
		},
		{
			name: "LinkedIn",
			icon: "fa6-brands:linkedin",
			url: "https://www.linkedin.com/in/kinesis19/",
		},
	],
};
